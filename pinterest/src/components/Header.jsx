  ...
  return (
    <>
      <div ref={headerRef} style={{position: 'sticky', zIndex: 1, top: 0, backgroundColor: 'white', height: 80, width: '100%', padding: '4px 16px', display: 'flex', alignItems: 'center'}}>
        <ul style={{listStyleType: 'none', margin: 0, padding: 0, display: 'flex', height: '100%', width: '100%', gap: 16}}>
          <li>
          ...
          {isAuthenticated ? 
            <>
              ...
              <li className="dropdown" >
                <div style={{display: "flex", justifyContent: "center", alignItems: "center", width: 28, height: 28, borderRadius: '50%'}} className="greybackground">
