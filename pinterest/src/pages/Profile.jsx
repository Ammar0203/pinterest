        ...
        {edit ? 
            ...
            <div style={{width: '100%', display: 'flex', justifyContent: 'center', gap: 48}}>
              <form className='form' onSubmit={onSubmit}>
                <div className='input-container'>
                  <img onClick={e => fileUpload.current.click()} src={image ? URL.createObjectURL(image) : (profile?.avatar ? `http://localhost:55/avatars/${profile?.avatar}` : avatar)} style={{borderRadius: "50%", width: 120, height: 120, objectFit: 'cover', alignSelf: 'center'}} />
          ...
          <>
            ...
            <div style={{display: "flex", flexDirection: "column", alignItems: "center", gap: 16, margin: '20px'}}>
              <img src={profile?.avatar ? `http://localhost:55/avatars/${profile?.avatar}` : avatar} style={{borderRadius: "50%", width: 120, height: 120, objectFit: 'cover'}} />
